<?php
function my_profile(){
    $query = mysql_query("SELECT DISTINCT * FROM users WHERE uid = '".$_SESSION['uid']."';");
    $counter = 0;
        ...
        echo '<table width="100%">
            <tr>
                <th>
                    ...
                    <b>Firstname: </b> '.$row['fname'].'<br>
                    <b>Lastname: </b> '.$row['lname'].'<br>
                    <b>Zipcode: </b> '.$row['zip'].'<br>
                    </table>
                </th>
            </tr>
        </table>';
...
?>
<div class="row">
	<form data-abide novalidate="novalidate" method="POST" action="index.php#MyAccount">
		<fieldset>
			<legend>My Profile</legend>
			<div class="row">
				<div class="small-12 columns">
                <?php my_profile();?>
					<button  name = "DeleteAcc" type="submit" class="medium button green">I'm Not Lonely Anymore (Delete Account)</button>
				</div>
			</div>
		</fieldset>
	</form>
